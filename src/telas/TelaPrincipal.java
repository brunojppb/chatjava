...
public class TelaPrincipal extends javax.swing.JFrame implements InterfaceController{
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(btnLogar, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void logarHandler(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logarHandler
        ...
        try {
            ...
            try {
                //cliente = (ClienteInterface) Naming.lookup(nome);
            } catch (Exception e) {
            ...
            JOptionPane.showMessageDialog(null, "Chat OffLine");
        }
